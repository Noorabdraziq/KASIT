                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 hidden-xs hidden-sm full_width">
                        <div class="gc_header_wrapper">
                            <div class="gc_logo">
                                <a href="index.php"><img src="images/header/logo.png" alt="Logo" width="40%" style="margin-top:-10px; background-color:#fff; border-radius: 5%;" title="KASIT Guide" class="img-responsive"></a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="gc_counter_cont_wrapper">
                <div class="count-description">
					...
					$sql11 = mysqli_query($dbConn,"select * from students");
					echo $num11 = mysqli_num_rows($sql11)+2698;
					?>
					
					
					
					</span><i class="fa fa-users"></i>
                    <h5 class="con1">Students</h5>
                </div>
            </div>
            <div class="gc_counter_cont_wrapper2">
                <div class="count-description">
                    <span class="timer">5</span><i class="fa fa-list"></i>
                    <h5 class="con2">Majors</h5>
                </div>
            </div>
           
		   <div class="gc_counter_cont_wrapper2">
                <div class="count-description">
                    <span class="timer">87</span><i class="fa fa-users"></i>
                    <h5 class="con3">Staff</h5>
                </div>
            </div>
            ...
            <div class="gc_counter_cont_wrapper4">
                <div class="count-description">
                    <span class="timer">7555</span><i class="fa fa-graduation-cap"></i>
                    <h5 class="con4">Graduates</h5>
                </div>
            </div>
        </div>
    </div>
