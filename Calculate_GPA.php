                        ...
                        <div class="jp_tittle_breadcrumb_main_wrapper">
                            <div class="jp_tittle_breadcrumb_wrapper">
                                <ul>
                                    ...
                                    <li style="color:#fff">Calculate GPA</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div id="lcol" class="" style="color:#000 !important">

	<div id="doc" class=" p-12 bg-secondary text-white  ">
		
		<div class="login_wrapper">
			<form id="calcform" name="calcform" class="calc" autocomplete="off">
			<table id="tbl" style="color:#000">
				<tr>
					<th>Courses</th>
					<th>Grade</th>
					<th>Credits / Hours</th>
			...
			<br>
					      <button type="button" id="addrow" title="Add row" class="btn btn-warning"><center> Add New Row</center></button>

			<br>
		   <div id="cumdiv" class="form-group">
		      <strong>Previous cumulative GPA / Credits (Optional)</strong>
		      <div class="row">
		     
		      
		      <input type="number" class="form-control"  id="cgpa" min="0" step="any" placeholder="Cumulative GPA" >
			  
			  <input type="number" class="form-control"   id="chours" min="0" step="any" placeholder="Credits" >
		   ...
		   <div class="form-group">
		      <button type="button" id="calcbtn" title="Calculate" class="btn btn-primary"><center> Calculate</center></button>
		      <button type="reset" id="resetbtn" title="Reset" class="btn btn-danger"> <center>Reset</center></button>
		   </div>
		   <div class="form-group">
...
<script>
   ...
   function Calc()
   {
      var glook=[-1,4.00, 3.67, 3.33, 3.00, 2.67, 2.33, 2.00, 1.67, 1.33, 1.00, 0.67, 0];
      var gpa=0;
      var sum=0;
      var txt1="";
      var txt2="";
   ...
   function AddRow()
   {
      $('#tbl > tbody > tr').eq(irow++).after("<tr>\         <td><input type='text' name='class[]' class='form-control' placeholder='Course "+irow+"'></td>\         <td><select name='grade[]' class='form-control'>\            <option selected>--</option>\            <option>A</option>\            <option>A-</option>\            <option>B+</option>\            <option>B</option>\            <option>B-</option>\            <option>C+</option>\            <option>C</option>\            <option>C-</option>\            <option>D+</option>\            <option>D</option>\            <option>D-</option>\            <option>F</option>\            </select></td>\         <td><input type='number' min='0' max='3' required step='any' name='hours[]' class='form-control'></td>\      </tr>");
   }
