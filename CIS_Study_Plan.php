                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="jp_tittle_heading_wrapper">
                        <div class="jp_tittle_heading">
                            <h2>CIS Study Plan</h2>
                        </div>
                        <div class="jp_tittle_breadcrumb_main_wrapper">
                            <div class="jp_tittle_breadcrumb_wrapper">
                                <ul>
                                    <li><a href="index.php">Home</a> <i style="color:#fff" class="fa fa-angle-right"></i></li>
                                    <li style="color:#fff">CIS Study Plan | <a href="CIS.pdf" class="btn btn-success" style="color:#fff" target="_blank">Download Study Plan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
  					...
  					<iframe src="CIS_Study_Plan.html" height="800px" width="120%" title="CIS Study Plan"></iframe>
