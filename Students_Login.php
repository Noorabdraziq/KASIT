...
$query = mysqli_query($dbConn,"SELECT * FROM students WHERE Student_Number='$Student_Number' AND Student_Password='$Password'"); 
...
echo '<script language="JavaScript">
	...
	echo '<script language="JavaScript">
	  alert ("Error ... Please Check Student Number Or Password !")
      </script>';
                        ...
                        <div class="jp_tittle_breadcrumb_main_wrapper">
                            <div class="jp_tittle_breadcrumb_wrapper">
                                <ul>
                                    ...
                                    <li style="color:#fff">Students Login</li>
                                </ul>
                            </div>
                        </div>
                    </div>
						...
						<div class="login_wrapper">
							...
							<div class="formsix-pos">
								<div class="form-group">
									<input type="text" class="form-control" required="" name="Student_Number" placeholder="Student Number *">
								</div>
							</div>
							<div class="formsix-e">
								<div class="form-group">
							...
							<div class="login_btn_wrapper">
								<input type="submit" name="Submit" value="Login" class="btn btn-primary login_btn" style="color: #fff;
    width: 100%;
    height: 50px;
    padding: 6px 25px;
    line-height: 36px;
