...
<a href="Important_Links.php" >Important Links</a>                                                      
                        ...
                        <div class="jp_tittle_breadcrumb_main_wrapper">
                            <div class="jp_tittle_breadcrumb_wrapper">
                                <ul>
                                    ...
                                    <li style="color:#fff">CS Study Plan | <a href="CS.pdf" class="btn btn-success" style="color:#fff" target="_blank">Download Study Plan</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
	...
	<iframe src="CS_Study_Plan.html"  height="800px" width="120%" title="CS Study Plan"></iframe>
